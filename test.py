from pygitbundle import create_bundle, verify_bundle, unpack_bundle, encrypt_bundle_with_password, decrypt_bundle_with_password
...
def test_decrypt_bundle_with_password():
    decrypt_bundle_with_password('test.bundle', '.', 'password')
    assert True
